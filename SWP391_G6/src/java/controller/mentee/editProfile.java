...
public class editProfile extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.editProfile(username, password, fullName, dob, gender, email, phoneNumber, address, u_id);
        response.getWriter().print("<script> alert(\"Profile edited successfully!\"); window.location = \"editProfile\";</script>");
    }
